...
var SimpleKinetic = (function (global) {'use strict';
  ...
  function SimpleKinetic(options) {
    for (var key in options) {
      ...
      if (key.slice(0, 2) === 'on' || key === 'context') {
        this[key.toLowerCase()] = options[key];
      }
    }
  }
...
try { module.exports = SimpleKinetic; } catch(meh) { /*\_(ツ)_*/ }